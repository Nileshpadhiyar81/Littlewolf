...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#a1,#a2,#a3,#a4').stop();
			...
			$('#a11').animate({top:280, left: vw-150},500);
			$('#a22').animate({top:280, left: vw-50},500);
			$('#a33').animate({top:280, left: vw+50},500);
			$('#a44').animate({top:280, left: vw+150},500);
	...
	function loopten() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#a1').animate({left:randleft,bottom:randtop},10000,function(){
			loopten();
		});
	}
	function loopeleven() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#a2').animate({left:randleft,bottom:randtop},10000,function(){
			loopeleven();
		});
	}
	function looptwelve() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#a3').animate({left:randleft,bottom:randtop},10000,function(){
			looptwelve();
		});
	}
	function loopthirteen() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#a4').animate({left:randleft,bottom:randtop},10000,function(){
			loopthirteen();
		});
	}
	...
	$('#balloons_flying').click(function(){
		...
		$('#b2,#b3,#b6,#b8,#a2,#a4,#a1,#a3').addClass('balloons-rotate-behaviour-two');
		loopOne();
		loopTwo();
		loopThree();
		loopFour();
